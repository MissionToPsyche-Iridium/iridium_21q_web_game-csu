...
@export var oreInfo = {
	"Cinnabar": "Composition:\nHgS\n\nDescription:\nMercuric Sulfide, commonly reffered to as Cinnabar, is know for its reddish color. The mineral is often used as a pigemnt as well as medicinal uses though it has seen a decline in those uses due to its toxicity. Cinnabar is the most common ore containing Mercury and is used to extract the metal.\n\nSource:\n",
...
@export var	statInfo = {
	...
	"Grabber Range": "Description:\nHow big the radius for the grbaber is.",
